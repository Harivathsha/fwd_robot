...
# Set gazebo sim resource path
    gazebo_resource_path = SetEnvironmentVariable(
        ...
        value=[
            ...
            str(Path(fws_robot_description_path).parent.resolve()), ':' + # <-- Added comma and colon
            '/home/harivathsha/gazebo_models'                             # <-- Added your new path!
        ]
    )
...
# Bridge
    bridge = Node(
        ...
        arguments=[
            ...
            '/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock'  # <--- ADD THIS LINE
        ],
        output='screen'
    )
